...
int main(int argc, char *argv[])
{
  ...
  {
    /*
    //Testing Vertical Seam
    int start_col = 1;
    int *minSeam = new int[height]{0};
    int totalE = getVerticalSeam(image, start_col, width, height, minSeam);
    cout << "The total energy is " << totalE<< endl;
    //cout << minSeam[0] << " " << minSeam[1] << " " << minSeam[2] << " " << minSeam[3] << endl;
    */
